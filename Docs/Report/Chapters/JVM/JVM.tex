...
typedef struct jcr {
  ...
  javaclass_class* classes;
  uint8_t* constants;
  javaclass_method_header* methods;
  uint8_t* bytecodes;
} javaclass_class_t;
\end{lstlisting}
\medskip
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{JVMRunTime.eps}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{JVMRunTimeAreas.eps}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{JVMRunTimeWithInt.eps}
\caption{JVM basic Run Time}
