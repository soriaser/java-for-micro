...
\usepackage[
  ...
  pdftitle={MASTEAM Final Project - Sergio Soria Nieto},
  pdfsubject={Development of a JVM for low and mid range microcontrollers and comparison with native applications.},
